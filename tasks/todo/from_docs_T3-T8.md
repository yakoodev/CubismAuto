...
- [x] Логировать, какие roots реально снапшотятся.
- [x] Ошибки доступа писать как `WARN` с путем, без падения.
- [x] В `report.md` добавить мини-итог: где были изменения и сколько найдено recent artifacts.
